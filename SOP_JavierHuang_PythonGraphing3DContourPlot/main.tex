...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			\end{verbatim}
		\end{enumerate}
		\item[5.] Display the plot
		\begin{enumerate}
			\item[] \begin{verbatim}
				plt.show()
			\end{verbatim}
		\end{enumerate}
		\item[6.] Finally, execute the code to see the contour plot open in a separate window
	\end{enumerate}
	...
	\item \textbf{Creating a Physics Related Plot}
	
	This example displays the gravitational potential of a point mass
	
	The function is replaced to be such:
	\begin{enumerate}
		\item[] \begin{verbatim}
	...
	Here is the complete code for creating a physics related 3D contour plot in Python
